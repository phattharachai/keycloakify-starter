...
// Map Keycloakify ClassKeys → Metronic Tailwind classes
...
export default function LoginUpdateProfile(props: Props) {
    ...
    // Merge page-specific class overrides on top of any passed-in classes
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col items-center gap-3 text-center">
                    <div className="flex items-center justify-center size-16 rounded-full bg-primary/10">
                        <i className="ki-filled ki-user-edit text-primary text-3xl" />
                    </div>
                    <div>
                ...
                >
                    {/* Dynamic fields rendered by Keycloakify — styled via profileClasses */}
